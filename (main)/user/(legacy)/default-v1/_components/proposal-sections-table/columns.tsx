...
function ProposalSectionDetailViewer({ item }: { item: ProposalSectionsRow }) {
  ...
  return (
    <Drawer swipeDirection={isMobile ? "down" : "right"} showSwipeHandle={isMobile ? true : false}>
      ...
      <DrawerContent className="overflow-x-hidden">
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto px-4 text-sm pb-4 scrollbar-thin">
          {!isMobile && (
            <>
