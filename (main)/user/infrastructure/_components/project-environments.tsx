    ...
    >
      <div className="flex flex-col gap-2 px-4 sm:flex-row sm:items-center">
        <CollapsibleTrigger
          render={
            <Button
              variant="ghost"
              size="sm"
              className="group -ml-2 w-full justify-start gap-2 px-2 hover:bg-transparent aria-expanded:bg-transparent sm:flex-1"
            />
          }
        >
        ...
        <div className="flex w-full items-center justify-between gap-2 sm:ml-auto sm:w-auto sm:justify-end">
          <Button variant="ghost" size="sm" className="-ml-1.5 sm:ml-0 border">
